...
for($j=0;$j<@k1;$j++)
{
    if(exists $hash{$k1[$j]} && $k3[$j]==100 && $k4[$j]==45 && $k5[$j]==0 && $k6[$j]==0 && ($k7[$j]==1 && $k8[$j]==45 || $k7[$j]==46 && $k8[$j]==90) && $k3[$j+1]==100 && $k4[$j+1]==45 && $k5[$j+1]==0 && $k6[$j+1]==0 && ($k7[$j+1]==1 && $k8[$j+1]==45 || $k7[$j+1]==46 && $k8[$j+1]==90) && $k1[$j] eq $k1[$j+1] && $k7[$j]!=$k7[$j+1] && $k8[$j]!=$k8[$j+1] && $k2[$j] ne $k2[$j+1])
        {
